...
gulp.task('default', function () {
    ...
    // Run when anything inside of client changes.
    gulp.watch('client/**', function () {
        runSeq('buildJS', 'reload');
    });

    // Run when scss inside of public/ changes.
    ...
    gulp.watch(['client/**/*.html', 'server/app/views/*.html'], ['reload']);

    // Run server tests when a server file or server test file changes.
    gulp.watch(['tests/server/**/*.js'], ['testServerJS']);

    // Run client testing when a client test file changes.
    gulp.watch('tests/client/**/*', ['testClientJS']);
